        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow">
            <form action="{{ route('store') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="email" name="email" type="email" placeholder="Tu Email de Registro" value="{{ old('email') }}"
                ...
                <div class="mb-5">
                    <label for="password" class="mb- block uppercase text-gray-500 font-bold">
                        Password
                    </label>
